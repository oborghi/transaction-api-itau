...
def generate_presentation():
    ...
    # ═══════════════════════════════════════════════════════════════
    # SLIDE 2 - Sumario da Apresentacao (em forma de bullets simples)
    # ═══════════════════════════════════════════════════════════════
    ...
    for i, b in enumerate(summary_bullets):
        pdf.set_fill_color(*C_AZUL_MEDIO)
        pdf.ellipse(x + 2, y + i * 11 + 1.2, 1.6, 1.6, 'F')
        pdf.set_text_color(*C_PRETO)
        pdf.set_font('Helvetica', '', 8.5)
        pdf.set_xy(x + 8, y + i * 11)
        pdf.cell(0, 4, b)
    ...
    if os.path.exists(img_v1):
        ...
        pdf.cell(0, 5, f'Diagrama nao encontrado: {img_v1}')

    # ═══════════════════════════════════════════════════════════════
    # SLIDE 4 - Arquitetura Atual (V1) - Diagnostico
    # ═══════════════════════════════════════════════════════════════
    ...
    # ═══════════════════════════════════════════════════════════════
    # SLIDE 5 - Justificativa: NoSQL vs SQL
    # ═══════════════════════════════════════════════════════════════
    ...
    # ═══════════════════════════════════════════════════════════════
    # SLIDE 9 - SLOs Existentes (README) e Propostas V2
    # ═══════════════════════════════════════════════════════════════
    ...
    # ═══════════════════════════════════════════════════════════════
    # SLIDE 13 - Diagrama da Arquitetura V2 (pagina dedicada)
    # ═══════════════════════════════════════════════════════════════
